...
ScenePathFindingAStar::ScenePathFindingAStar()
{
	draw_grid = false;
...
void ScenePathFindingAStar::update(float dtime, SDL_Event* event)
{
...
void ScenePathFindingAStar::draw()
{
	drawMaze();
	drawCoin();
...
const char* ScenePathFindingAStar::getTitle()
{
	return "SDL Path Finding :: A*";
}

void ScenePathFindingAStar::drawMaze()
{
...
void ScenePathFindingAStar::drawCoin()
{
...
bool ScenePathFindingAStar::loadTextures(char* filename_bg, char* filename_coin)
{
